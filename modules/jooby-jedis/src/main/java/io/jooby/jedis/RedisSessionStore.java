...
public class RedisSessionStore implements SessionStore {
  ...
  public Session newSession(String id) {
    final Session session = new SessionImpl(key(id));
  ...
  public Session findSession(String id) {
    ...
    try {
      ...
      final Session session = new SessionImpl(key);
      attrs.forEach(session::put);
      session.setCreationTime(epochSeconds(attrs, "_createdAt"));
      session.setLastAccessedTime(epochSeconds(attrs, "_accessedAt"));
      return session;
    } finally {
      if (jedis != null) {
        jedis.close();
  ...
  public void save(final Session session) {
    ...
    try {
      ...
      Map<String, String> attrs = session.toMap();
      attrs.put("_createdAt", String.valueOf(session.getCreationTime().getEpochSecond()));
      attrs.put("_accessedAt", String.valueOf(session.getLastAccessedTime().getEpochSecond()));
      attrs.put("_savedAt", String.valueOf(Instant.now().getEpochSecond()));
  ...
  private static Instant epochSeconds(Map<String, String> attrs, String key) {
    try {
